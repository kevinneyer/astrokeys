            ...
            <div className='social-div'>
                <Menu widths={1} fixed='bottom' text >
                    <Grid  verticalAlign='centered' > 
                        ...
                        <a href='https://www.facebook.com/pg/TheAstroKeys/about/?ref=page_internal' target='_blank'><Icon className='socials' name='facebook' size='big' color='black' /></a>
                        <a href='https://open.spotify.com/album/0OpEKaIDNyWPhwQmjlQlvs?si=d3vvmiO7S5OwkqY6S5njfA' target='_blank'><Icon className='socials' name='spotify' size='big' color='black' /></a>
